...
const Frame1: React.FC<Frame1Props> = ({ navigateToFrame }) => {
  return (
    <div className="bg-white w-full max-w-md mx-auto p-6 rounded-lg shadow-md">
      ...
      <div className="flex justify-center mb-6">
        <button className="bg-gray-300 px-4 py-2 rounded" onClick={() => navigateToFrame('Frame2')}>Analyse durchführen</button>
      </div>
